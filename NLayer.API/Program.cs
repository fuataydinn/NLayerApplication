...
{
    options.SuppressModelStateInvalidFilter = true; //burada kendi filter'ýný kullanma API, beným yaptýgýmý kullan dedýk. Yoksa calýsmýyor, yukarýda yazdýgým filter.
} );
